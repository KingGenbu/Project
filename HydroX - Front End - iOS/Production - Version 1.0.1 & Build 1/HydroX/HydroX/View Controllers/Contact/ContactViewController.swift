...
class ContactViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        vwRectangleRound.addGestureRecognizer(UITapGestureRecognizer(target: self, action: #selector(tapToNavigateRemoveHydroXFriendVC(_:))))
    ...
    @objc func tapToNavigateRemoveHydroXFriendVC(_ sender: UITapGestureRecognizer) {
        let removeHydroXFriindVC = self.storyboard?.instantiateViewController(withIdentifier: StoryboardIdentefier.removeHydroXFriend.rawValue) as! RemoveHydroXFreindsVC
        self.navigationItem.titleView = nil
        navigationController?.pushViewController(removeHydroXFriindVC, animated: true)
    }
