...
class RemoveHydroXFreindsVC: UIViewController {
    
    @IBOutlet var tblRemoveHydroXFriends: UITableView!
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        self.tblRemoveHydroXFriends.delegate = nil
        self.tblRemoveHydroXFriends.dataSource = nil
        tblRemoveHydroXFriends.layer.cornerRadius = 2.0
        tblRemoveHydroXFriends.layer.borderWidth = 0.25
        tblRemoveHydroXFriends.layer.borderColor = UIColor.lightGray.cgColor
    ...
    @objc func rightBarSearchButton(_ sender:UIBarButtonItem)  {
         let searchHydroXFriendsVC = Helper.mainStoryBoard.instantiateViewController(withIdentifier: StoryboardIdentefier.searchHydroXFriendsVC.rawValue) as! SearchHydroXFriendsVC
        let navController = UINavigationController(rootViewController: searchHydroXFriendsVC)
    ...
    func setupTableViewData() {
        ...
        if sections.count > 0 {
            self.tblRemoveHydroXFriends.reloadData()
            self.tblRemoveHydroXFriends.delegate = self
            self.tblRemoveHydroXFriends.dataSource = self
        }
    }
...
extension RemoveHydroXFreindsVC: UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        let returnedView = UIView(frame: CGRect(x: 0, y: 0, width: self.tblRemoveHydroXFriends.frame.width, height: 30))
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: CellIdentifier.cellRemoHydroXFriends.rawValue, for: indexPath) as! ContactCell
